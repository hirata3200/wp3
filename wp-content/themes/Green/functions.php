...
register_default_headers( array(
	'image1' => array(
		...
		'description'   => '私たちは笑顔と緑をお届けする、インテリアの会社です。',
	),
) );
...
/**
 * タームのスラッグを取得するオリジナル関数（CHAOTER 25）
 */
...
/**
 * 画像表示用ショートコード ... サンプル記事内に画像を利用するためのオリジナルショートコード
 */

function default_image( $args ) {
...
add_shortcode( 'image_path', 'default_image' );
